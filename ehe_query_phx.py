...
gfdl_esm2g_26 = pd.merge(gfdl_esm2g_26, phx_T1, on='latlon')
gfdl_esm2g_26 = pd.merge(gfdl_esm2g_26, phx_T2, on='latlon')
...
gfdl_esm2g_45 = pd.merge(gfdl_esm2g_45, phx_T1, on='latlon')
gfdl_esm2g_45 = pd.merge(gfdl_esm2g_45, phx_T2, on='latlon')
...
gfdl_esm2g_60 = pd.merge(gfdl_esm2g_60, phx_T1, on='latlon')
gfdl_esm2g_60 = pd.merge(gfdl_esm2g_60, phx_T2, on='latlon')
...
gfdl_esm2g_85 = pd.merge(gfdl_esm2g_85, phx_T1, on='latlon')
gfdl_esm2g_85 = pd.merge(gfdl_esm2g_85, phx_T2, on='latlon')
